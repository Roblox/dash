...
describe("class", function()
	...
	it("throws for operators which are not implemented", function()
		...
		expect(function()
			return car + car2
		end).toThrowError([[NotImplemented: The method "__add" is not implemented on the class "Vehicle"]])
		expect(function()
			return car * car2
		end).toThrowError([[NotImplemented: The method "__mul" is not implemented on the class "Vehicle"]])
		expect(function()
			return car - car2
		end).toThrowError([[NotImplemented: The method "__sub" is not implemented on the class "Vehicle"]])
		expect(function()
			return car / car2
		end).toThrowError([[NotImplemented: The method "__div" is not implemented on the class "Vehicle"]])
		expect(function()
			return car % car2
		end).toThrowError([[NotImplemented: The method "__mod" is not implemented on the class "Vehicle"]])
	end)
