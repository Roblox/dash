...
local function forEachPairs(input: any, handler: any)
	assertEqual(typeof(input), "table", [[Attempted to call Dash.forEachPairs with argument #1 of type {left:?} not {right:?}]])
	assertEqual(typeof(handler), "function", [[Attempted to call Dash.forEachPairs with argument #2 of type {left:?} not {right:?}]])
